...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dot_shaped_radio.setGeometry(QtCore.QRect(300, 60, 82, 17))
        ...
        self.circle_shaped_radio.setGeometry(QtCore.QRect(300, 90, 82, 17))
        ...
        self.simulation_speed_val.setProperty("value", 10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(
            _translate("MainWindow", "Minimal distance between dots (m)")
        )
    ...
    def fonction_couteau_suisse(self, d: int):
    ...
    def go(self):
        with open("files\\config.txt", "w") as f:
            f.write("")
        with open("files\\config.txt", "a") as f:
